...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $konfirmasi_password) {
        $_SESSION['forgot_password_error'] = 'Password dan konfirmasi password tidak cocok';
    ...
    if (!file_exists($user_file)) {
        $_SESSION['forgot_password_error'] = 'Database pengguna tidak ditemukan';
        header('Location: ../pages/forgot_password.php');
        exit();
    }
    ...
    if (!$email_found) {
        $_SESSION['forgot_password_error'] = 'Email tidak ditemukan';
        header('Location: ../pages/forgot_password.php');
        exit();
    }
    ...
    $_SESSION['forgot_password_success'] = 'Password berhasil diubah. Silakan login dengan password baru Anda.';
