    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="form-container">
                <h2 class="text-center mb-4 fw-bold">Ubah Password</h2>

                <?php if (isset($_SESSION['change_password_error'])): ?>
                    <div class="alert alert-danger mb-4">
                        <?= $_SESSION['change_password_error']; unset($_SESSION['change_password_error']); ?>
                    </div>
                <?php endif; ?>

                <?php if (isset($_SESSION['change_password_success'])): ?>
                    <div class="alert alert-success mb-4">
                        <?= $_SESSION['change_password_success']; unset($_SESSION['change_password_success']); ?>
                    </div>
                <?php endif; ?>
